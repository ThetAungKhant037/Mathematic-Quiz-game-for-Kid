...
public class TwoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final int lengthinmili = 10000;
    ...
    int score=0;
    int totQuestion=QuestionModel2.question.length;
    int noOfQ=0;
    ...
    public void onClick(View view) {
        ...
        if(clieckedButton.getId()==R.id.btnZeroSummit){
            timer.cancel();
            if(selectedAnswer.equals(QuestionModel2.answer[therandomorder[currentQuestionIndex]])){
                score++;
                tvScore.setText("Score:"+score);
                player= MediaPlayer.create(TwoActivity.this,R.raw.correct);
                player.start();
                ...
                player= MediaPlayer.create(TwoActivity.this,R.raw.wrong);
                player.start();
    ...
    private void loadQuestion() {
        ...
        StartCountDown();
        question.setText(QuestionModel2.question[therandomorder[currentQuestionIndex]]);
        btnZeroQ1Ans1.setText(QuestionModel2.choices[therandomorder[currentQuestionIndex]][0]);
        btnZeroQ1Ans2.setText(QuestionModel2.choices[therandomorder[currentQuestionIndex]][1]);
        btnZeroQ1Ans3.setText(QuestionModel2.choices[therandomorder[currentQuestionIndex]][2]);

    }

    private void finishQuiz() {
        Intent intent=new Intent(TwoActivity.this,ThankActivity.class);
